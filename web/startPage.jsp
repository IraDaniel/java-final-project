...
<div class="navbar navbar-default navbar-static-top" role="navigation">
    <div class="container">
        ...
        <ul class="nav navbar-nav navbar-left">
            ...
            <li><a href="newUser.jsp"><%= utilProperty.getValue("util.register")%>
            </a></li>
            <li><a href="enterPage.jsp"><%= utilProperty.getValue("util.login")%>
            </a></li>
        </ul>

        <ul class="nav navbar-nav navbar-right">
            <li><a href="LocaleServlet?loc=ru&url=startPage.jsp">ru</a></li>
            <li><a href="LocaleServlet?loc=en&url=startPage.jsp">en</a></li>
        </ul>
    </div>
</div>
